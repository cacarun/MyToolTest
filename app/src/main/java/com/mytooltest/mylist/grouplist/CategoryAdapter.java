...
/**
 * Created by jarvis on 2019/2/13.
 */
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        switch (itemViewType) {
            case TYPE_CATEGORY_ITEM:
                if (null == convertView) {
                    convertView = mInflater.inflate(R.layout.group_list_my_item_header, null);
                }
            ...
            case TYPE_ITEM:
                ...
                if (null == convertView) {
                    ...
                    convertView = mInflater.inflate(R.layout.group_list_my_item, null);
                ...
                viewHolder.contentIcon.setImageResource(R.drawable.empty);
                break;
        }
