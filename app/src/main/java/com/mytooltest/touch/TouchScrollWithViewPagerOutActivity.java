 ...
 *
 * 这里只是演示 ScrollView 嵌套 ViewPager 外部拦截法
 */
public class TouchScrollWithViewPagerOutActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_touch_scroll_with_viewpager_out);
        initView();
        initListener();
        initData();
    }
    ...
    private BaseFragmentAdapter mBaseViewPagerAdapter;
    ...
    private void initData() {
        ...
        mBaseViewPagerAdapter = new BaseFragmentAdapter(getSupportFragmentManager(), mFragments);
