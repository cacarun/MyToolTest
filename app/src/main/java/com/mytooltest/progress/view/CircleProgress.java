...
public class CircleProgress extends View {
    ...
    protected void initVar(Context context, AttributeSet attrs) {
        ...
        progressInitialPosition = ta.getInteger(R.styleable.CircleProgress_progressInitialPosition, -90); // 进度条的起始位置
        ...
        isCircleCorner = ta.getBoolean(R.styleable.CircleProgress_isCircleCorner, true); // 边角是否是圆的
        isSolid = ta.getBoolean(R.styleable.CircleProgress_isSolid, false); // 是否是实心的
        ta.recycle();
