...
package com.mytooltest.imageloader.worker.util;
...
import com.mytooltest.BuildConfig;
import com.mytooltest.imageloader.worker.ImageResizer;
...
public class ImageCache {
     ...
     * @param cacheParams The cache parameters to use if the ImageCache needs instantiation.
     * @return Return a new image cache object.
     */
                ...
                protected void entryRemoved(boolean evicted, String key,
                    ...
                    if (RecyclingBitmapDrawable.class.isInstance(oldValue)) {
                        ...
                        if (WorkerUtils.hasHoneycomb()) {
                        	...
                        	// lock this object for sometimes ConcurrentModificationException occured 
    ...
    public Bitmap getBitmapFromReusableSet(BitmapFactory.Options options) {
        ...
        // lock this hashMap for sometimes ConcurrentModificationException occured
        synchronized(mReusableBitmaps) {
	...
	public static File getDiskCacheDir(Context context, String uniqueName) {
		...
		try {
			...
			Log.d(TAG, "diskCachedPath = " + cachePath);
    ...
    public static int getBitmapSize(BitmapDrawable value) {
        ...
        if (WorkerUtils.hasHoneycombMR1()) {
